...
echo git remote add origin https://DriCro6663@github.com/DriCro6663/%REPOSITORY_NAME%.git
call git remote add origin https://DriCro6663@github.com/DriCro6663/%REPOSITORY_NAME%.git
